                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="<?php echo e(route('admin.login')); ?>" class="pt-2" method="post">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/shubhangip/zywie/zywiepms/resources/views/admin/admin_login.blade.php ENDPATH**/ ?>