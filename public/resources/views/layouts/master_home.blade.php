...
<html lang="en">
    <head>
        ...
        <!-- jvectormap -->
        <link href="{{ asset('Frontend/libs/jqvmap/jqvmap.min.css')}}" rel="stylesheet" />
    ...
    <body>
        ...
        <!-- Jvector map -->
        <script src="{{ asset('Frontend/libs/jqvmap/jquery.vmap.min.js')}}"></script>
        <script src="{{ asset('Frontend/libs/jqvmap/jquery.vmap.usa.js')}}"></script>
